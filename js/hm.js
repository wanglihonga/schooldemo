(function() {
    var c = {
        id: "da6f1445af3167cf70ef00845d0e716b",
        dm: ["ems.com.cn"],
        etrk: [],
        ...
        return function(d) {
            ...
            default:
                ...
                if (d instanceof Array) {
                    ...
                    g,
                    m;
                    for (g = 0; g < k; g++) switch (m = d[g], typeof m) {
                    case "undefined":
                    case "function":
                    case "unknown":
                        break;
    ...
    var ba = navigator.cookieEnabled,
    ca = navigator.javaEnabled(),
    da = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLanguage || "",
    ea = window.screen.width + "x" + window.screen.height,
    fa = window.screen.colorDepth;
    var G;
    function H() {
        if (!G) try {
    ...
    function ma(a) {
        if (window.localStorage) {
            ...
            return G.load(document.location.hostname),
            G.getAttribute(a)
        } catch(e) {}
        return n
    };
    ...
    na = "cc cf ci ck cl cm cp cw ds ep et fl ja ln lo lt nv rnd sb se si st su sw sse v cv lv u api tt".split(" ");
    function oa() {
    ...
    function pa(a) {
        try {
            ...
            a: if (document.referrer) {
                for (var m = 0,
                ua = c.se.length; m < ua; m++) if (RegExp("(^|\\.)" + c.se[m][1].replace(/\./g, "\\.")).test(A(document.referrer))) {
                    ...
                    if (y || !(2 != c.se[m][0] && 14 != c.se[m][0] && 17 != c.se[m][0])) {
                        ...
                        a.a.se = c.se[m][0];
                        for (var za = a.a,
                        q = c.se[m], J = 0, Aa = 2 == q[3] ? q[1] + "\\/": "", Ba = 1 == q[3] ? "\\." + q[1] : "", V = q[4].split(","), q = 0, Ca = V.length; q < Ca; q++) if ("" !== V[q] && RegExp(Aa + V[q] + Ba).test(document.referrer)) {
                            J = q + 1;
                            break
                        }
                        za.sse = J;
            ...
            if (0 == c.nv && T(document.location.href) && ("" == document.referrer || T(document.referrer))) b = 0,
            d = 4;
            a.a.nv = b;
            a.a.st = d;
            a.a.cc = e;
            ...
            0 == a.a.nv ? ta() : S(".*");
            if ("" != c.icon) {
                var v, w = c.icon.split("|"),
                Y = "http://tongji.baidu.com/hm-web/welcome/ico?s=" + c.id,
                Z = ("http:" == Q ? "http://eiv": "https://bs") + ".baidu.com" + w[0] + "." + w[1];
                switch (w[1]) {
                case "swf":
                    var ia = w[2],
                    ja = w[3],
            ...
            Da = RegExp(c.id),
            Ea = -1 < document.referrer.indexOf("baidu.com") ? l: p;
            if (N && Da.test(N) && Ea) {
            ...
            a.m && a.m();
            a.l && a.l();
            if (c.rec || c.trust) a.a.nv ? (a.g = encodeURIComponent(document.referrer), window.sessionStorage ? s("Hm_from_" + c.id, a.g) : ga("Hm_from_" + c.id, a.g, 864E5)) : a.g = (window.sessionStorage ? t("Hm_from_" + c.id) : ma("Hm_from_" + c.id)) || "";
            a.n && a.n();
            a.o && a.o();
            a.e = new ya;
            r(window, "beforeunload", xa(a));
            var x = window._hmt;
            if (x && x.length) for (v = 0; v < x.length; v++) {
                var B = x[v];
                switch (B[0]) {
                case "_setAccount":
            ...
            if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
                ...
                var P = window._hmt;
                if (P && P.length) for (var x = 0,
                Ga = P.length; x < Ga; x++) a.k(P[x]);
                window._hmt = a.p
            }
            if ("undefined" === typeof window._bdhm_autoPageview || window._bdhm_autoPageview === l) a.h = l,
            a.a.et = 0,
            a.a.ep = "",
            R(a)
        } catch(la) {
            a = [],
            a.push("si=" + c.id),
            a.push("n=" + encodeURIComponent(la.name)),
            a.push("m=" + encodeURIComponent(la.message)),
            a.push("r=" + encodeURIComponent(document.referrer)),
            C(Q + "//hm.baidu.com/hm.gif?" + a.join("&"))
        }
    }
    function wa(a) {
    ...
    function sa() {
        ...
        try {
            if (aa(a, "", {
                ...
                G.load(document.location.hostname),
                G.removeAttribute(a),
    ...
    function ra() {
        ...
        b = c.dm.length; a < b; a++) {
            var d = c.dm[a];
            if ( - 1 < d.indexOf("/") && Fa(document.location.href, d)) return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
        }
        return "/"
    }
    function qa() {
        ...
        b = 0,
        d = c.dm.length; b < d; b++) if (U(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
        return a
    }
    function T(a) {
        for (var b = 0; b < c.dm.length; b++) if ( - 1 < c.dm[b].indexOf("/")) {
            if (Fa(a, c.dm[b])) return l
        } else {
            var d = A(a);
            if (d && U(d, c.dm[b])) return l
        }
        return p
    }
    function Fa(a, b) {
